export const roomsList = [
	...
	{ id: 2, title: 'Люкс', imageUrl: '/images/rooms/room3_1.png', images: ['/images/rooms/room3_1.png', '/images/rooms/room3_2.png', '/images/rooms/room3_3.png', '/images/rooms/room3_4'], price: '3500', description: ['с/у', 'удобная мебель в современном стиле', 'индивидуальная система кондиционирования воздуха', 'жк телевизор', 'Wi-Fi доступ в интернет', 'полотенце для душа, для рук, ног, тапочки, жидкое мыло', 'фен', 'мини-холодильник', 'чайный набор', 'сушилка для белья', 'гладильные принадлежности на этаже'] },
]
