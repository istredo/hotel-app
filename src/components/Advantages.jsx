export const advList = [
	...
	{ title: 'Зона отдыха', description: 'Живая музыка, караоке и вкуснейшие коктейли.', imageUrl: '/images/advantages/chill.jpg' },
...
const Advantages = (props) => {
	return (
		<div className='advantages__item'>
			...
			{/* <div className={props.style} alt={props.title} /> */}
